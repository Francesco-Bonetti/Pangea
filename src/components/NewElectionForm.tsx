...
export default function NewElectionForm() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8">
      ...
      <p className="text-slate-400 mb-8">Set up a new election for citizens to participate in.</p>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full px-4 py-3 bg-slate-800 border border-slate-600 rounded-lg text-white placeholder-slate-500 focus:outline-none focus:border-purple-500 resize-none"
            rows={4}
          />
        </div>
        ...
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-3 bg-slate-800 border border-slate-600 rounded-lg text-white placeholder-slate-500 focus:outline-none focus:border-purple-500"
          />
          <p className="text-xs text-slate-500 mt-1">The title of the role being elected.</p>
        </div>

        {/* Max Winners */}
        <div>
          <label className="block text-sm font-medium text-slate-300 mb-2">Number of Seats</label>
          <input
            type="number"
            value={maxWinners}
            ...
            min={1}
            max={50}
            className="w-32 px-4 py-3 bg-slate-800 border border-slate-600 rounded-lg text-white focus:outline-none focus:border-purple-500"
          />
        ...
        <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <label className="block text-xs text-slate-400 mb-1">Candidature Opens</label>
              <input
                type="datetime-local"
                value={candidatureStart}
                onChange={(e) => setCandidatureStart(e.target.value)}
                className="w-full px-3 py-2.5 bg-slate-900 border border-slate-600 rounded-lg text-white text-sm focus:outline-none focus:border-purple-500"
              />
            </div>
            <div>
              <label className="block text-xs text-slate-400 mb-1">Candidature Closes</label>
              <input
                type="datetime-local"
        ...
        <button
          type="submit"
          disabled={submitting}
          className="w-full py-3 bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-500 hover:to-purple-600 text-white font-medium rounded-lg transition-all duration-150 disabled:opacity-50 disabled:cursor-not-allowed"
        >
