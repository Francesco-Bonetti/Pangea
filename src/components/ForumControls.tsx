    ...
    <div className="flex gap-2 w-full sm:w-auto">
      ...
      <form onSubmit={handleSearchSubmit} className="flex-1 relative">
        <input
          ...
          className="w-full px-3 py-2 pl-9 bg-slate-900 border border-slate-700 rounded-lg text-slate-100 placeholder-slate-400 text-sm focus:outline-none focus:border-pangea-600"
        />
