        ...
        <div className="space-y-12">
          ...
          <section>
            <div className="flex items-center gap-2 mb-6">
              ...
              <h2 className="text-2xl font-semibold text-fg">Our Principles</h2>
            </div>
          ...
          {/* FAQ */}
          <section>
            <h2 className="text-2xl font-semibold text-fg mb-6">Frequently Asked Questions</h2>
            <div className="space-y-4">
              {[
                {
          ...
          <div className="card p-8 bg-pangea-900/30 border border-pangea-700/30 text-center">
            <h3 className="text-2xl font-semibold text-fg mb-4">Ready to Participate?</h3>
