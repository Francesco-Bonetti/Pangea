const en = {
  ...
  groups: {
    ...
    // T10: Group Settings & Hierarchical Locks
    settings: {
      title: "Settings",
      description: "Configure how this group operates. Some settings may be locked by a parent group.",
      visibility: "Visibility",
      visibilityDesc: "Who can see this group",
      visibilityPublic: "Public — visible to everyone",
      visibilityPrivate: "Private — visible only to members",
      visibilityMembersOnly: "Members Only — hidden from non-members",
      canPost: "Who Can Post",
      canPostDesc: "Who is allowed to create posts in this group",
      canPostAnyone: "Anyone",
      canPostMembers: "Members only",
      canPostAdmins: "Admins only",
      joinPolicy: "Join Policy",
      joinPolicyDesc: "How new members can join this group",
      joinPolicyOpen: "Open — anyone can join",
      joinPolicyApproval: "Approval — requires admin approval",
      joinPolicyInvite: "Invite Only — by invitation only",
      canCreateSubgroups: "Subgroup Creation",
      canCreateSubgroupsDesc: "Who can create child groups",
      canCreateSubgroupsAnyone: "Anyone",
      canCreateSubgroupsMembers: "Members only",
      canCreateSubgroupsAdmins: "Admins only",
      locked: "Locked by parent",
      lockedBy: "Locked by",
