const en = {
  ...
  settings: {
    ...
    pageDesc: "Manage your profile, privacy, and preferences",
    // Account info
    ...
    displayNamePlaceholder: "Alternative name shown when your real name is hidden",
    displayNameHint: "If you hide your real name, this will be shown instead. For example: \"EcoVoter42\" or \"Citizen X\".",
    bioCharCount: "characters",
    // Delegations section
    delegationsSection: "Delegations",
    ...
    privacyDesc: "Control what other citizens can see about you. These settings apply across the entire platform.",
    // Profile Visibility card
    profileVisibilitySection: "Profile Visibility",
    profileVisibilityDesc: "Choose who can see your profile page. For example, if you select \"Private\", only your display name or citizen code will be visible.",
    visibilityPublic: "Public",
    visibilityPublicDesc: "Anyone can see your profile, including visitors who are not logged in",
    visibilityRegistered: "Registered citizens only",
    visibilityRegisteredDesc: "Only logged-in citizens can see your profile details",
    visibilityPrivate: "Private",
    visibilityPrivateDesc: "Your profile is hidden. Only your display name or citizen code is visible",
    // Visible Information card
    visibleInfo: "Visible Information",
    visibleInfoDesc: "Choose which details are visible to other citizens. For example, you can hide your real name and show only your display name.",
    showRealName: "Show real name",
    showRealNameDesc: "Display your full name on your profile and in posts",
    showBio: "Show bio",
    showBioDesc: "Display your biography on your profile page",
    showEmail: "Show email",
    showEmailDesc: "Display your email address (hidden by default for safety)",
    showJoinDate: "Show join date",
    showJoinDateDesc: "Show when you joined the platform",
    showCitizenCode: "Show citizen code",
    showCitizenCodeDesc: "Display your unique citizen identifier",
    profilePrivateNote: "Your profile is set to Private. Most fields are automatically hidden. Only your citizen code visibility can be toggled.",
    // Activity Visibility card
    activityVisibilitySection: "Activity Visibility",
    activityVisibilityDesc: "Control who can see your activity on the platform. For example, you can hide your proposals and votes from other citizens.",
    activityPublic: "Public",
    activityPublicDesc: "Anyone can see your activity",
    activityRegistered: "Registered citizens only",
    activityRegisteredDesc: "Only logged-in citizens",
    activityPrivate: "Private",
    activityPrivateDesc: "Nobody can see your activity",
    showProposalsVotes: "Show proposals & votes",
    showProposalsVotesDesc: "Display your voting and proposal activity",
    ...
    showGroupMembershipsDesc: "Display which groups you belong to",
    // Messaging & Social card
    messagingSocial: "Messaging & Social",
    messagingSocialDesc: "Control how other citizens can interact with you. These settings will apply to direct messages and social features.",
    whoCanDm: "Who can send you direct messages?",
    dmEveryone: "Everyone",
    dmEveryoneDesc: "Any citizen can message you",
    dmFollowedOnly: "People you follow",
    dmFollowedOnlyDesc: "Only citizens you follow can message you",
    dmNobody: "Nobody",
    dmNobodyDesc: "Direct messages are disabled",
    allowFriendRequests: "Allow friend requests",
    allowFriendRequestsDesc: "Let other citizens send you connection requests",
    allowMentions: "Allow mentions",
    allowMentionsDesc: "Let other citizens @mention you in discussions",
    showOnlineStatus: "Show online status",
    showOnlineStatusDesc: "Let others see when you are active on the platform",
    // Notification Preferences card
    notificationPrefs: "Notification Preferences",
    notificationPrefsDesc: "Choose which notifications you want to receive. These will apply when the notification system is activated.",
    notifyMentions: "Mentions",
    notifyMentionsDesc: "When someone @mentions you",
    notifyReplies: "Replies",
    notifyRepliesDesc: "When someone replies to your posts or comments",
    notifyDelegationsLabel: "Delegations",
    notifyDelegationsDesc: "When someone delegates their vote to you or changes delegation",
    notifyProposals: "Proposals",
    notifyProposalsDesc: "Updates on proposals you voted on or authored",
    notifyDm: "Direct messages",
    notifyDmDesc: "When you receive a new direct message",
    // Save privacy
    savePrivacy: "Save privacy settings",
    savingPrivacy: "Saving...",
    privacySaved: "Privacy settings saved!",
    // Group Vote Weights
    groupVoteWeights: "Group Vote Weights",
    groupVoteWeightsDesc: "If you are a member of multiple groups, your vote is split based on these weights. For example, if Group A has weight 2 and Group B has weight 1, Group A gets ~67% of your vote.",
    ofYourVote: "% of your vote",
    saveGroupWeights: "Save group weights",
    ...
    dualProfile: {
      ...
      showBioPublicly: "Show bio publicly",
      showBioPubliclyDesc: "Display your biography on your public profile",
      showEmailPublicly: "Show email publicly",
      showEmailPubliclyDesc: "Display your email on your public profile",
      showActivityPublicly: "Show activity publicly",
      showActivityPubliclyDesc: "Display your proposals and votes on your public profile",
      showDelegationsPublicly: "Show delegations publicly",
      showDelegationsPubliclyDesc: "Display your delegation relationships on your public profile",
      showGroupMembershipsPublicly: "Show group memberships publicly",
      showGroupMembershipsPubliclyDesc: "Display which groups you belong to on your public profile",
    },
  },
